# youtube-watch-video-session Specification

## Purpose

Define how the extension identifies YouTube watch-page video sessions and validates video identity before applying per-video actions.
