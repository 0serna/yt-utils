# subscriptions-grid-density Specification

## Purpose

Modify the YouTube desktop subscriptions feed grid layout to display 4 video cards per row instead of the default 3.
